window.addEventListener("error",e=>{const box=document.getElementById("categories");if(box&&!box.children.length)box.innerHTML=`<section class="category"><h2>⚠️ Crove Tools 加载失败</h2><div class="out">JavaScript 错误：${e.message}</div></section>`});
const DATA=[
["⭐ 常用工具",[
